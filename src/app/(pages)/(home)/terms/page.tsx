  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <section className="flex flex-col gap-4">
        ...
        <p>
          Ao acessar e utilizar o Release Fast, você concorda em cumprir e ficar
          vinculado aos seguintes termos e condições de uso. Se você não
          concordar com qualquer parte destes termos, não deverá utilizar nossa
          plataforma.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-4">
        ...
        <ul className="flex flex-col gap-1">
          ...
          <li className="flex items-center gap-4">
            ...
            Garante que possui todos os direitos necessários para compartilhar o
            conteúdo;
          </li>
        </ul>
      </section>
      ...
      <section className="flex flex-col gap-4">
        ...
        <p>
          ...
          você concorda com nossas práticas de privacidade conforme descrito em
      ...
      <section className="flex flex-col gap-4">
        ...
        <p>
          ...
          As alterações entrarão em vigor imediatamente após sua publicação. O
          uso continuado da plataforma após as modificações constitui aceitação
          dos novos termos.
        </p>
      </section>

      <section className="flex flex-col gap-4">
        <h3 className="text-lg font-bold">7. Limitação de Responsabilidade</h3>
      ...
      <section className="flex flex-col gap-4">
        ...
        <p>
          Para questões relacionadas a estes termos, entre em contato através do
          email de{' '}
